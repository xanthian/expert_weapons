...
public class VsasWeaponsCompat {
    ...
    // Acacia
    public static final Item DULL_ACACIA_IRON_SWORD = registerItem("vsascompat/dull_acacia_iron_sword", new SwordItem(DullMaterials.DULL_IRON,3,-2.4f, new FabricItemSettings().group(ExpertGroup.EXPERT_WEAPONS))	{
        @Override
    ...
    // Birch
    public static final Item DULL_BIRCH_IRON_SWORD = registerItem("vsascompat/dull_birch_iron_sword", new SwordItem(DullMaterials.DULL_IRON,3,-2.4f, new FabricItemSettings().group(ExpertGroup.EXPERT_WEAPONS))	{
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant").formatted(Formatting.ITALIC, Formatting.RED));
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant2").formatted(Formatting.ITALIC, Formatting.GRAY));
    ...
    // Crimson
    public static final Item DULL_CRIMSON_IRON_SWORD = registerItem("vsascompat/dull_crimson_iron_sword", new SwordItem(DullMaterials.DULL_IRON,3,-2.4f, new FabricItemSettings().group(ExpertGroup.EXPERT_WEAPONS))	{
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant").formatted(Formatting.ITALIC, Formatting.RED));
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant2").formatted(Formatting.ITALIC, Formatting.GRAY));
    ...
    // Dark_oak
    public static final Item DULL_DARK_OAK_IRON_SWORD = registerItem("vsascompat/dull_dark_oak_iron_sword", new SwordItem(DullMaterials.DULL_IRON,3,-2.4f, new FabricItemSettings().group(ExpertGroup.EXPERT_WEAPONS))	{
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant").formatted(Formatting.ITALIC, Formatting.RED));
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant2").formatted(Formatting.ITALIC, Formatting.GRAY));
    ...
    // Jungle
    public static final Item DULL_JUNGLE_IRON_SWORD = registerItem("vsascompat/dull_jungle_iron_sword", new SwordItem(DullMaterials.DULL_IRON,3,-2.4f, new FabricItemSettings().group(ExpertGroup.EXPERT_WEAPONS))	{
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant").formatted(Formatting.ITALIC, Formatting.RED));
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant2").formatted(Formatting.ITALIC, Formatting.GRAY));
    ...
    // Oak
    public static final Item DULL_OAK_IRON_SWORD = registerItem("vsascompat/dull_oak_iron_sword", new SwordItem(DullMaterials.DULL_IRON,3,-2.4f, new FabricItemSettings().group(ExpertGroup.EXPERT_WEAPONS))	{
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant").formatted(Formatting.ITALIC, Formatting.RED));
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant2").formatted(Formatting.ITALIC, Formatting.GRAY));
    ...
    // Spruce
    public static final Item DULL_SPRUCE_IRON_SWORD = registerItem("vsascompat/dull_spruce_iron_sword", new SwordItem(DullMaterials.DULL_IRON,3,-2.4f, new FabricItemSettings().group(ExpertGroup.EXPERT_WEAPONS))	{
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant").formatted(Formatting.ITALIC, Formatting.RED));
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant2").formatted(Formatting.ITALIC, Formatting.GRAY));
    ...
    // Warped
    public static final Item DULL_WARPED_IRON_SWORD = registerItem("vsascompat/dull_warped_iron_sword", new SwordItem(DullMaterials.DULL_IRON,3,-2.4f, new FabricItemSettings().group(ExpertGroup.EXPERT_WEAPONS))	{
        @Override
        public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant").formatted(Formatting.ITALIC, Formatting.RED));
            tooltip.add(new TranslatableText("tooltip.export_weapons.no_enchant2").formatted(Formatting.ITALIC, Formatting.GRAY));
